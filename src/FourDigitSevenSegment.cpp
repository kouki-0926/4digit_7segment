...
// The 1st parameter is the Arduino pin number that connects to the 74HC595 SER
// pin. The 2nd parameter is the Arduino pin number that connects to the 74HC595
// SRCLK pin. The 3rd parameter is the Arduino pin number that connects to the
// 74HC595 RCLK pin. The 4th parameter is the number of 74HC595 connected in
// cascade. The 5th parameter selects whether to send from LSB or MSB.
